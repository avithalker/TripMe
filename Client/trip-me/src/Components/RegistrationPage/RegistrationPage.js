        ...
        <div className="col registration-form">
          ...
          <form>
              ...
              <input
                ...
                className={
                  ...
                  this.ValidationClass(
                    this.state.fieldValidationContext.UserNameField.isValid
                  )
                }
                onChange={this.onInputChange}
            ...
            <div className="form-group">
              <input
                ...
                className={
                  "form-control" +
                  this.ValidationClass(
                    this.state.fieldValidationContext.PasswordField.isValid
                  )
                }
                onChange={this.onInputChange}
            ...
            <div className="row mr-0 ml-0">
              <button
                type="submit"
                className="btn btn-info register-btn"
  ...
  HandleRegistrationError = error => {
    ...
    switch (error) {
      case RegistrationStatus.TAKEN_USERNAME: {
        ...
        fieldValidationContext.UserNameField.errorMessage =
          "User name is taken";
        break;
      }
